...
const DeckListView: React.FC<DeckListViewProps> = ({ decks, onStartReview, onShowImport, onShowSmartGeneration, onStrengthenWeakness, onShowImageGeneration, onShowImageAnalysis, onShowTranscription, onShowTextAnalysis, onShowBackup }) => {
        ...
        />
         <div className="flex gap-2 flex-wrap justify-center">
            ...
            <button
              ...
              className="px-4 py-2 bg-pink-600 hover:bg-pink-700 rounded-lg font-semibold transition-colors whitespace-nowrap"
            >
              Backup & Restore
            </button>
        </div>
